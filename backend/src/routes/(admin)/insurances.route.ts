...
insuranceRoutes.post("/insurance", authMiddleware, privateRoute, new CreateInsuranceController().handle)
insuranceRoutes.post("/insurances/find", authMiddleware, privateRoute, new FindInsuranceController().handle)
